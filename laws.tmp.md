...
As an online discussion grows longer, the probablility of a comparison to Nazis/Hitler approaches 100%
...
Anything that can go wrong will go wrong (also called Sod's law)
...
(Also called Robustness Principle) Be conservative in what you send, liberal in what you accept (not necessarily a good idea, see Hyrum's law)
...
The first 90% of code accounts for the first 90% of development time, the remaining 10% of the code accounts for the other 90% of development time
...
Disproportionate time is spent on trivial issues (Also called bikeshedding)
